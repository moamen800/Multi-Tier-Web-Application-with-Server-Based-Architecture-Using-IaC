...
resource "aws_lb_listener" "http_listener" {
  ...
  default_action {
    ...
    target_group_arn = aws_lb_target_group.app_servers_target_group.arn # Forward traffic to the target group
  }
}
...
resource "aws_lb_target_group" "app_servers_target_group" {
  ...
  tags = {
    Name = "app-servers App Target Group" # Tag for identifying the target group
  }
}
